...
public class RobotAgent : Agent, IRobot
{
	...
	private void Update() {
        ...
        if (transform.localRotation.x > 120 || transform.localRotation.z > 120 || transform.localRotation.x < -120 || transform.localRotation.z < -120)
        {
            EndEpisode();
